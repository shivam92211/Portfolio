...
export const metadata: Metadata = {
  title: "Shivam Vishwakarma",
  description:
    "Shivam Vishwakarma is a proficient Data Scientist and Full Stack AI ML Engineer from India, skilled in front-end and back-end development using modern tech stacks.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
